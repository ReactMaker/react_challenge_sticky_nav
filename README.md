# react_challenge_sticky_nav

捲動畫面到特定位置後，將選單使用CSS固定在上方

![Imgur](https://i.imgur.com/bFUKrpI.gif)
...
```bash
$ git clone https://github.com/ReactMaker/react_challenge_sticky_nav
$ cd react_challenge_sticky_nav
